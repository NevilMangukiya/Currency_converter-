...
class CupertinoBTCScreen extends StatefulWidget {
  const CupertinoBTCScreen({Key? key}) : super(key: key);

  @override
  State<CupertinoBTCScreen> createState() => _CupertinoBTCScreenState();
}

class _CupertinoBTCScreenState extends State<CupertinoBTCScreen> {
